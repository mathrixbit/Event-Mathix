...
def check_answer():
    ...
    if user_answer in [ans.replace(" ", "").lower() for ans in correct_answers]:
        Mathrix_send_image("/static/images/IMG20250111145756.jpg",caption=" ")
        Mathrix_send_image("/static/images/IMG20250111151051.jpg",caption=" ")
        Mathrix_send_image("/static/images/IMG20250111151545.jpg",caption=" ")
